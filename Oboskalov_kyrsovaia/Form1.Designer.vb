...
Partial Class Form1
    ...
    Private Sub InitializeComponent()
        ...
        '
        Me.СправочникиToolStripMenuItem.DropDownItems.AddRange(New System.Windows.Forms.ToolStripItem() {Me.СтудентыToolStripMenuItem, Me.ГруппыToolStripMenuItem, Me.МедицинскиеОрганизацииToolStripMenuItem, Me.МедицинскиеКартыToolStripMenuItem, Me.СтудентыОтветсвенныеЗаПропускиПоБолезниToolStripMenuItem})
        ...
        '
        Me.СтудентыToolStripMenuItem.Name = "СтудентыToolStripMenuItem"
        Me.СтудентыToolStripMenuItem.Size = New System.Drawing.Size(288, 22)
        Me.СтудентыToolStripMenuItem.Text = "Студенты"
        '
    ...
    Friend WithEvents СтудентыToolStripMenuItem As ToolStripMenuItem
